    ...
    <div class="space-y-6 p-4 sm:p-6 lg:p-8 max-w-xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-5 border-b border-slate-100 bg-slate-50/50">
                <h3 class="font-bold text-slate-800">Informasi Kategori</h3>
                <p class="text-sm text-slate-500 mt-1">Buat kategori baru untuk mengelompokkan barang.</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('categories.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="name" class="block w-full border-slate-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-20 transition-colors" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Contoh: Makanan, Minuman, Sembako" />
                    </div>
